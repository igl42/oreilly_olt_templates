/**************************************************************************************************
*
* \file VariadicCartesianProduct.cpp
...
template< int N >
using number_of_ranges = std::integral_constant<int,N>;

template< int N, typename Func, typename Range, typename... Args >
void cartesian_product_impl( number_of_ranges<N>, Func func, Range const& range, Args const&... args )
{
   for( auto const& element : range ) {
      cartesian_product_impl( number_of_ranges<N-1>{}, func, args..., element );
   }
}

template< typename Func, typename Range, typename... Args >
void cartesian_product_impl( number_of_ranges<1>, Func func, Range const& range, Args const&... args )
{
   for( auto const& element : range ) {
      func( args..., element );
   }
...
{
   cartesian_product_impl( number_of_ranges<sizeof...(Ranges)>{}, func, ranges... );
}
