...
decltype(auto) apply( Fn&& fn, Tuple&& tuple, std::index_sequence<Is...> indices )
{
...
decltype(auto) apply( Fn&& fn, Tuple&& tuple )
{
   ...
   return apply( std::forward<Fn>(fn), std::forward<Tuple>(tuple),
...
// See https://en.cppreference.com/w/cpp/utility/apply for a complete implementation.
